...
$(document).ready(function() {
    ...
    if ($('.mask_citizen').length > 0) {
        $(".mask_citizen").mask("9-9999-99999-99-9");
    }
    if ($('.mask_telephone').length > 0) {
        $(".mask_telephone").mask("99-999-9999");
    }
    if ($('.mask_telephone_upcountry').length > 0) {
        $(".mask_telephone_upcountry").mask("999-999-999");
    }
    if ($('.mask_mobile').length > 0) {
        $(".mask_mobile").mask("999-999-9999");
    }
     if ($('.mask_fax').length > 0) {
        $(".mask_fax").mask("9-9999-9999");
    }
    if ($('.mask_isbn').length > 0) {
        $(".mask_isbn").mask("999-999-9999-99-9");
    }

    if ($('.mask_academyCode').length > 0) {
        $(".mask_academyCode").mask("999999");
    }
    if ($('.mask_academySMIS').length > 0) {
        $(".mask_academySMIS").mask("99999999");
    }
    if ($('.mask_academyMinistry').length > 0) {
        $(".mask_academyMinistry").mask("9999999999");
    }
    // tag-input
